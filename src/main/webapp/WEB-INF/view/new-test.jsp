		...
		<div id="new-test-submission-form" class="container">
			<div class="container test-meta-info">
				<form>
					...
					<div class="form-group row">
						<label class="col-sm-2 col-form-label" for="test-name">Enter
							the test name</label>
						<div class="col-sm-10">
							<input id="test-name" name="test-name" type="text"
								placeholder="describe the test with a name"
								class="form-control input-md" required=""> <span
								class="help-block">a couple words should be enough</span>
						</div>
					</div>

					<!-- Textarea -->
					<div class="form-group row">
						<label class="col-sm-2 col-form-label" for="test-description">Enter
							the test description</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="test-description"
								name="test-description">give a few words...</textarea>
						</div>
					</div>

					<!-- Text input-->
					<div class="form-group row">
						<label class="col-sm-2 col-form-label" for="test-duration">Enter
							the test duration (minutes)</label>
						<div class="col-sm-10">
							<input id="test-duration" name="test-duration" type="text"
								placeholder="be reasonable" class="form-control input-md"
								required=""> <span class="help-block">5 minus is
								rarely enough to complete a test...</span>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<div class="checkbox">
								<label for="is-public"> <input type="checkbox"
									id="is-public" value="0"> Do not publish the test (so
			...
			<div id="test-content" class="container">
				<div class="test-question">
					<div class="test-question-row row">
						<label class="col-sm-2" for="test-question">Enter the
							question body</label>
						<div class="col-sm-10">
							<textarea class="form-control test-question-body"
								name="test-question">here goes the question...</textarea>
						</div>
					</div>
					<div class="test-question-row test-answer row">
						<label class="col-sm-2" for="test-answer">Enter the answer
							option body</label>
						<div class="col-sm-8">
							<textarea class="form-control test-answer-body"
								name="test-answer">here goes the answer...</textarea>
						</div>
						<div class="col-sm-2 checkbox">
							<label for="checkbox-one"> <input type="checkbox"
								id="checkbox-one" class="should-be-checked" value="0">
								should be checked
							</label>
						</div>
					</div>
					<div class="test-question-row mx-auto">
						<button type="button" class="btn btn-success"
							id="add-answer-option" onclick="insertAnswerDiv(this)">add
							answer</button>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<button id="add-question" type="button"
					class="btn btn-success btn-lg btn-block">Add question</button>
				<button id="submit-new-test" type="button"
					class="btn btn-primary btn-lg btn-block">Done!</button>
			</div>
