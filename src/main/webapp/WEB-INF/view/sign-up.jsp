...
<body>
	...
	<div class="container">
        ...
        <form class="form-horizontal" id="singUpForm" action="${pageContext.request.contextPath}/sign-up" method="post">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="firstName" name="firstNameInput" type="text" placeholder="" value="testLogin" class="form-control input-md" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label" for="logininput">Login</label>
                    <div class="col-md-4">
                        <input id="lastName" name="lastNameInput" type="text" placeholder="" value="testLogin" class="form-control input-md" required="">
                    </div>
                </div>
