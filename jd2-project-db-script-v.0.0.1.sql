...
-- -----------------------------------------------------
-- Schema test-system-db-0.0.1
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `test-system-db-0.0.1` ;

-- -----------------------------------------------------
-- Schema test-system-db-0.0.1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `test-system-db-0.0.1` DEFAULT CHARACTER SET utf8 ;
USE `test-system-db-0.0.1` ;

-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`categories` (
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`subcategories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`subcategories` (
  ...
  CONSTRAINT `fk_subcategories_categories1`
    ...
    REFERENCES `test-system-db-0.0.1`.`categories` (`idcategory`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`users` (
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`questions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`questions` (
  ...
  CONSTRAINT `fk_questions_subcategories1`
    ...
    REFERENCES `test-system-db-0.0.1`.`subcategories` (`idsubcategory`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_questions_users1`
    FOREIGN KEY (`users_iduser`)
    REFERENCES `test-system-db-0.0.1`.`users` (`iduser`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`answers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`answers` (
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`questions_has_answers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`questions_has_answers` (
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`tags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`tags` (
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`questions_has_tags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`questions_has_tags` (
  `questions_idquestions` INT NOT NULL,
  ...
  CONSTRAINT `fk_questions_has_tags_tags1`
    ...
    REFERENCES `test-system-db-0.0.1`.`tags` (`idtag`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`authorities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`authorities` (
  `idauthority` INT NOT NULL AUTO_INCREMENT,
  `authority` VARCHAR(45) NOT NULL,
  `users_iduser` INT NOT NULL,
  PRIMARY KEY (`idauthority`, `users_iduser`),
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`tests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`tests` (
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`tests_has_questions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`tests_has_questions` (
  ...
  CONSTRAINT `fk_tests_has_questions_tests1`
    ...
    REFERENCES `test-system-db-0.0.1`.`tests` (`idtest`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`users_has_tests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`users_has_tests` (
  `users_iduser` INT NOT NULL,
  `tests_idtest` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `test-system-db-0.0.1`.`users_has_subscribers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test-system-db-0.0.1`.`users_has_subscribers` (
  `users_iduser` INT NOT NULL,
